...
userRouter.post(
    ...
    [
        ...
        body("phoneNumber").matches(/^\d{7,15}$/).withMessage("Phone number must contain only digits"),
...
userRouter.put(
    ...
    [
        ...
        body("phoneNumber").optional().matches(/^\d{7,15}$/).withMessage("Phone number must contain only digits"),
        body("isDefault").optional().isBoolean().withMessage("isDefault must be a boolean"),
    ],
    validateRequest,
